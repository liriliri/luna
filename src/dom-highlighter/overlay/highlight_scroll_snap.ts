...
import type {Bounds, PathCommands, Position} from './common';
import type {LineStyle, PathBounds} from './highlight_common';
import {drawPath, emptyBounds} from './highlight_common';
