  ...
  private initTpl() {
    this.$container.html(
      ...
      <ul class="keys">
        ...
        <li data-key="8"><span>delete</span></li>
        <li data-key="9"><span>tab</span></li>
        ...
        <li data-key="16"><span>⇧</span></li>
        <li data-key="-1"><span>fn</span></li>
        <li data-key="17"><span>control</span></li>
        <li data-key="18"><span>alt</span><span>option</span></li>
        <li data-key="91"><span>command</span></li>
        <li data-key="32"><span></span></li>
        <li data-key="93"><span>command</span></li>
        <li data-key="18"><span>alt</span><span>option</span></li>
